...
void print_usage()
{
  ...
  fprintf(stderr, "   -r|--root_addr rootserver address\n");
  fprintf(stderr, "   -o|--root_port rootserver port\n");
  ...
  fprintf(stderr, "   -f|--schema_file if schema_file set, will not fetch from rootserver\n");
