  ...
  namespace common
  {
    class ObScanParam : public ObReadParam
    {
      public:
        ...
        inline const ObRange* const get_range() const { return &range_; }
        ...
        inline const ObString* const get_column_name() const { return column_names_; }
        ...
        int add_groupby_column(const oceanbase::common::ObString & column_name);
        ...
        int add_return_column(const oceanbase::common::ObString & column_name);
        ...
        int add_aggregate_column(const oceanbase::common::ObString & org_column_name, 
                                 const oceanbase::common::ObString & as_column_name, 
                                 const oceanbase::common::ObAggregateFuncType  aggregate_func);
        int add_aggregate_column(const int64_t org_column_idx, const oceanbase::common::ObAggregateFuncType  aggregate_func); 
