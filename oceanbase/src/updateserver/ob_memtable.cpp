...
namespace oceanbase
{
  namespace updateserver
  {
    ...
    int MemTableIterator::get_cell(oceanbase::common::ObCellInfo **cell_info)
    {
      return get_cell(cell_info, NULL);
    }

    int MemTableIterator::get_cell(oceanbase::common::ObCellInfo **cell_info, bool *is_row_changed)
    {
      int ret = OB_SUCCESS;
      if (is_iter_end_
          && !row_not_exist_)
