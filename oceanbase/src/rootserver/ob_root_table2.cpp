...
int ObRootTable2::create_table(const common::ObTabletInfo& tablet, const int32_t* server_indexes, const int32_t replicas_num, const int64_t tablet_version)
    ...
    int32_t ObRootTable2::find_suitable_pos(const const_iterator& it, const int32_t server_index, const int64_t tablet_version)
    {
      int32_t found_it_index = OB_INVALID_INDEX;
      for (int32_t i = 0; i < OB_SAFE_COPY_COUNT; i++)
      {
    ...
    void ObRootTable2::merge_one_tablet(ObRootTable2* shrunk_table, int32_t last_tablet_index, const_iterator it)
    {
      int32_t i = 0;
