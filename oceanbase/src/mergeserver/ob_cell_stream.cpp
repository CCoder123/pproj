...
oceanbase::mergeserver::ObMSGetCellArray::ObMSGetCellArray()
:cell_array_(NULL),get_param_(NULL)
{
}

oceanbase::mergeserver::ObMSGetCellArray::ObMSGetCellArray(ObCellArray &cell_array)
:cell_array_(&cell_array),get_param_(NULL)
{
}

oceanbase::mergeserver::ObMSGetCellArray::ObMSGetCellArray(const ObGetParam &get_param)
:cell_array_(NULL),get_param_(&get_param)
{
}


int64_t oceanbase::mergeserver::ObMSGetCellArray::get_cell_size()const
{
  int64_t result = 0;
  if (NULL != get_param_)
  {
...
const ObCellInfo & oceanbase::mergeserver::ObMSGetCellArray::operator [](int64_t offset)const
{
