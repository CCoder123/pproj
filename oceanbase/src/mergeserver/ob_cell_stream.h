...
namespace oceanbase
{
  namespace mergeserver
  {
    ...
    public:
      ...
      ObMSGetCellArray(const oceanbase::common::ObGetParam & get_param);
      ...
      const oceanbase::common::ObCellInfo & operator[](int64_t offset)const;

    private:
      common::ObCellArray *cell_array_;
      const oceanbase::common::ObGetParam *get_param_;
      oceanbase::common::ObCellInfo default_cell_;
    };
    ...
    class ObUPSCellStream : public oceanbase::common::ObIterator
    {
    public:
    ...
    public:
      ...
      virtual int get(const oceanbase::common::ObReadParam &read_param,   
                      ObMSGetCellArray & get_cells, const ObMergerTabletLocation &cs_addr)=0;
      /// @fn prepare to do scan query, may just prepare, 
      ///   whether doing actions was decided by implementation
      virtual int scan(const oceanbase::common::ObScanParam &scan_param, 
      ...
      virtual void set_cache(oceanbase::common::ObVarCache<> &cache)
      {
        UNUSED(cache);
      }
      ...
      virtual int get_cache_row(const oceanbase::common::ObCellInfo & key,  ObRowCellVec *& result)
      {
        UNUSED(key);
        UNUSED(result);
        return oceanbase::common::OB_ENTRY_NOT_EXIST;
      }
    }; 
  }
}
